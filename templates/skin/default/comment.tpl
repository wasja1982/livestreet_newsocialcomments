...
<section id="comment_id_{$oComment->getId()}" class="comment
	...
	<ul class="comment-info">
		...
		{if $oComment->getTargetType() != 'talk'}
			...
			{if $oUserCurrent or $oConfig->GetValue('plugin.newsocialcomments.enabled')or $oConfig->GetValue('plugin.newsocialcomments.use_vk_api') or $oConfig->GetValue('plugin.newsocialcomments.use_fb_api') or $oConfig->GetValue('plugin.newsocialcomments.use_mr_api')}
